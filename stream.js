...
async function handleRecovery(reason, page) {
    try {
        ...
        await new Promise(r => setTimeout(r, 5000)); // Page proper load hone ka wait
        ...
        throw err; // Agar recovery fail ho gayi toh yeh Error thow karega aur mainLoop system restart kar dega.
    }
}
...
async function cleanup() {
    try { await obs.disconnect(); } catch (e) {} // Disconnect WebSocket
